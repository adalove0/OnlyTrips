      ...
      <div class = "addTrip">
        <div id = "circle">
          ...
          <div className="number">
	          ...
	          <div className ="input-text-counter"><input id = "numPeople" type="text" value={`${this.state.count} ${this.state.passengerNoun}`} onChange={this.handleChange} min={0} required="required"/></div>
