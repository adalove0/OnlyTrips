...
final lightTheme = ThemeData(
  primarySwatch: MaterialColor(4280923894,{50: Color( 0xffe7f7fe )
    , 100: Color( 0xffceeefd )
    , 200: Color( 0xff9ddefb )
    , 300: Color( 0xff6ccdf9 )
    , 400: Color( 0xff3bbcf7 )
    , 500: Color( 0xff0aacf5 )
    , 600: Color( 0xff0889c4 )
    , 700: Color( 0xff066793 )
    , 800: Color( 0xff044562 )
    , 900: Color( 0xff022231 )
  }),
  brightness: Brightness.light,
  primaryColor: Color( 0xff29b6f6 ),
  primaryColorBrightness: Brightness.light,
  primaryColorLight: Color( 0xffceeefd ),
  primaryColorDark: Color( 0xff066793 ),
  accentColor: Color( 0xff0aacf5 ),
  accentColorBrightness: Brightness.light,
  ...
  toggleableActiveColor: Color( 0xff0889c4 ),
  secondaryHeaderColor: Color( 0xffe7f7fe ),
  textSelectionColor: Color( 0xff9ddefb ),
  cursorColor: Color( 0xff4285f4 ),
  textSelectionHandleColor: Color( 0xff6ccdf9 ),
  backgroundColor: Color( 0xff9ddefb ),
  dialogBackgroundColor: Color( 0xffffffff ),
  indicatorColor: Color( 0xff0aacf5 ),
  ...
  buttonTheme: ButtonThemeData(
    ...
    colorScheme: ColorScheme(
      primary: Color( 0xff29b6f6 ),
      primaryVariant: Color( 0xff066793 ),
      secondary: Color( 0xff0aacf5 ),
      secondaryVariant: Color( 0xff066793 ),
      surface: Color( 0xffffffff ),
      background: Color( 0xff9ddefb ),
      error: Color( 0xffd32f2f ),
      onPrimary: Color( 0xff000000 ),
      onSecondary: Color( 0xff000000 ),
  ...
  chipTheme: ChipThemeData(
    ...
    secondarySelectedColor: Color( 0x3d29b6f6 ),
